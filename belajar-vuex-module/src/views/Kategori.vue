<template>
  ...
  <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-md text-center">
      ...
      <p class="mt-4 text-base text-gray-700">BERBAGAI KATEGORI BARANG DAN PAKAIAN</p>
    </div>


    <div class="mt-10 grid grid-cols-3 gap-6 lg:mt-16 lg:grid-cols-4 lg:gap-4">
        <div v-for="kategori in getKategori" :key="kategori.id">
        
      <article class="relative">
        <div class="aspect-square overflow-hidden">
          <img class="group-hover:scale-125 h-full w-full object-cover transition-all duration-300" src="https://radarcirebon.id/wp-content/uploads/2023/03/barang-elektronik.png" alt="" />
        </div>
