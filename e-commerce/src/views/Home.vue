<template>
    ...
    <div class="relative py-12 sm:py-16 lg:pt-20 xl:pb-0">
      <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-3xl text-center">
          ...
          <p class="mx-auto mt-12 max-w-md leading-7 text-gray-600">Ikaa Store Adalah Sebuah Ecommerce Unggulan Dalam Kualitas Produk Yang Sangat Bagus Dan Banyak Di beli</p>
  
          <div class="group relative mt-10 inline-flex">
            <a href="/product" title="" class="rounded-xl bg-blue-700 px-10 py-3 font-medium text-white transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:ring-offset-2 hover:bg-blue-600">Produk</a>
  ...
  <div class="mt-4 px-5 pb-5">
    <a href="#">
      <h5 class="text-xl tracking-tight text-slate-900">Solid Gold OVO Nike Air Jordan </h5>
    </a>
